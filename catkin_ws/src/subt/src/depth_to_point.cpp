...
void depth_to_point::callback(const sensor_msgs::ImageConstPtr& msg_depth){
	...
	sensor_msgs::ImageConstPtr image_msg = ros::topic::waitForMessage<sensor_msgs::Image>("/camera/color/image_raw",ros::Duration(10));
...
depth_to_point::depth_to_point(){
	...
	depth_image = nh.subscribe<sensor_msgs::Image>("/camera/depth/image_rect_raw", 1, &depth_to_point::callback,this); 
